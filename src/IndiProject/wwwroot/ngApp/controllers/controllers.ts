namespace IndiProject.Controllers {
    ...
    export class addArtistController {
        ...
        public addArtist() {
            return this.ArtistResource.save(this.artist)
                .$promise.then(() => { this.$state.go('artists') }
                );
        }
    ...
    export class editArtistController {
        ...
        public editArtist() {
            ...
            return this.ArtistResource.save({
                id: this.artistId
            }, this.artist).$promise.then(() => { this.$state.go('artists') }
                );
        }
    ...
    export class addAlbumToArtistController {
        ...
        public addAlbumToArtist() {
            ...
            return this.AlbumResource.save
                (this.album).$promise.then(() => { this.$state.go('albums') }
                );
        }
    ...
    export class editAlbumController {
        ...
        public editAlbum() {
            ...
            return this.AlbumResource.save({ id: this.albumId }, this.album).$promise.then(() => { this.$state.go('albums') });
          }
    ...
    export class detailsController { 
        ...
        public getAlbum() {
            this.album = this.AlbumResource.get({
                id: this.albumId
            });
        }
