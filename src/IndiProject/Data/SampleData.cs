...
namespace IndiProject.Data
{
    public class SampleData
    {
        public async static Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            var thrice = new Artist { Name = "Thrice", Genre = "Post-Harcore" };
            var aDayToRem = new Artist { Name = "A Day to Remember", Genre = "Pop Punk" };
            var mandyMoore = new Artist { Name = "Mandy Moore", Genre = "Pop" };
            var jtim = new Artist { Name = "Justin Timberlake", Genre = "Pop" };
            var prince = new Artist { Name = "Prince", Genre = "Funk" };
            var manO = new Artist { Name = "Manchester Orchestra", Genre = "Indie Rock" };
            var brandNew = new Artist { Name = "Brand New", Genre ="Post-Harcore" };
            var sugar = new Artist { Name = "Sugarcult", Genre = "Punk Rock" };
            var dr = new Artist { Name = "Dr.Dre", Genre = "Hip-Hop"};
            var killers = new Artist { Name = "The Killers", Genre = "Pop Punk"};
           

            if (!context.Artists.Any())
            {
                context.Artists.AddRange(thrice, aDayToRem, mandyMoore, jtim, prince, manO, brandNew, sugar, dr, killers);
                context.SaveChanges();
            }

            var hotFuss = new Album { Name = "Hot Fuss", Artist = killers, ApplicationUser = lizz, Year = "2004", Rating ="4.3"};
            var chronic = new Album { Name = "The Chronic", Artist = dr, ApplicationUser = kealy, Year = "1992", Rating = "3.9" };
            var twoThousand = new Album { Name = "2001", Artist = dr, ApplicationUser = kealy, Year = "2001", Rating = "3.7" };
            var hope = new Album { Name = "Hope", Artist = manO, ApplicationUser = lizz, Year = "2014", Rating = "5.0" };
            var cope = new Album { Name = "Cope", Artist = manO, ApplicationUser = lizz, Year = "2014", Rating = "5.0" };
            var daisy = new Album { Name = "Daisy", Artist = brandNew, ApplicationUser = lizz, Year = "2009", Rating = "4.8" };
            var signO = new Album { Name = "Sign '0' The Times", Artist = prince, ApplicationUser = lizz, Year = "1987", Rating = "3.6" };
            var deja = new Album { Name = "Deja Entendu", Artist = brandNew, ApplicationUser = kealy, Year = "2003", Rating = "4.6" };
            var everywhere = new Album { Name = "To be everywhere is to be Nowhere", Artist = thrice, ApplicationUser = kealy, Year = "2016", Rating = "2.8" };
            var major = new Album { Name = "Major/Minor", Artist = thrice, ApplicationUser = kealy, Year = "2011", Rating = "3.8" };
            var homesick = new Album { Name = "Homesick", Artist = aDayToRem, ApplicationUser = lizz, Year = "2009", Rating = "4.7" };
            var old = new Album { Name = "Old Record", Artist = aDayToRem, ApplicationUser = kealy, Year = "2008", Rating = "3.9" };
            var palm = new Album { Name = "Palm Trees and Power Lines", Artist = sugar, ApplicationUser = lizz, Year = "2004", Rating = "3.9" };
            var future = new Album { Name = "FutureSex/LoveSounds ", Artist = jtim, ApplicationUser = lizz, Year = "2006", Rating = "3.5" };
            var twenty = new Album { Name = "The 20/20 Experience", Artist = jtim, ApplicationUser = lizz, Year = "2013", Rating = "4.3" };
            var simple = new Album { Name = "Simple Math", Artist = manO, ApplicationUser = kealy, Year = "2011", Rating = "4.5" };
            var wild = new Album { Name = "Wild Hope", Artist = mandyMoore, ApplicationUser = lizz, Year = "2007", Rating = "2.5" };
            var coverage = new Album { Name = "Coverage", Artist = mandyMoore, ApplicationUser = kealy, Year = "2003", Rating = "3.3" };
            var common = new Album { Name = "Common Courtsey", Artist = aDayToRem, ApplicationUser = lizz, Year = "2013", Rating = "4.6" };
